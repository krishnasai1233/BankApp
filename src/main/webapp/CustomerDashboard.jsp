...
<%@ page import="com.banking.model.Customer_login, java.util.*, com.banking.model.Transaction, com.bankingapp.dao.Customer_loginDAO" %>
...
<head>
    ...
    <style>
        ...
        .details-1 p, .transaction-list p {
            margin: 0;
            font-size: 0.875rem;
        }
...
<% 
    ...
    Customer_login customer = (Customer_login) session.getAttribute("customer");
