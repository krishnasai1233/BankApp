<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.bankingapp.dao.Admin_loginDAO,com.banking.model.Customer_login,java.util.*" %>
...
<%
	...
	List<Customer_login> customers = admin.getCustomerDetails();
        ...
        <div class="form-container hidden" id="customer-details">	
         <br><br>
            ...
            <table class="table table-hover">
				...
				<%
					for(Customer_login customer:customers){
						%>
						<tr>
